<form action="" method="post">
    ...
    <div id="shipping-settings-wrap" class="shipping-settings-wrap wrap">
                ...
                <tbody>
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp forminp-text">
                            <input type="text" value="<?= Msb_livraison_shipping_calculator::$APIurl ?>" name="APIurl" id="APIurl" class="regular-text" placeholder=""  readonly>
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp forminp-text">
                            ...
                            <p class="description" id="tagline-description">Dispatch customer code, allowed customer code are returned by authentication, you can get customer list with a dedicated method</p>
                        </td>
                    </tr> 
